...
namespace BingoMod.UI.States
{
    internal class BoardUIState : UIState
    {
        ...
        public override void OnInitialize()
        {
            ...
            boardPanel.Width.Set((TextureAssets.InventoryBack9.Value.Width * Main.inventoryScale + 4) * 5 + 4, 0f);
            boardPanel.Height.Set((TextureAssets.InventoryBack9.Value.Height * Main.inventoryScale + 4) * 5 + 4, 0f);
